...
# Remove bridge-claude-code integration from Hermes Agent config
# ─────────────────────────────────────────────────────────────
...
echo ""
echo "┌──────────────────────────────────────────────────┐"
echo "│  bridge-claude-code → Hermes Agent: remove        │"
echo "└──────────────────────────────────────────────────┘"
echo ""
...
" 2>/dev/null && ok "Reset to NousResearch provider" || warn "Could not fully reset — run 'hermes model' to reconfigure interactively"
    ...
    ok "Config no longer references bridge-claude-code"
  fi
fi
